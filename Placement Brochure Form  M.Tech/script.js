...
document.getElementById("i2").addEventListener('change',clickupload("fileurl2","18CLYTQptvZ5IoBX0sQcjZrn3vjPUM22i","i2"))
document.getElementById("i3").addEventListener('change',clickupload("fileurl3","1RaKfbEVxi2TF1LHjf0-Ey90qZG4LoXT3","i3"))
document.getElementById("i4").addEventListener('change',clickupload("fileurl4","1nzu58KbXSVMf5rpDCOuNE62hbfcib_76","i4"))
document.getElementById("i5").addEventListener('change',clickupload("fileurl5","1lzxPGFfw43jtVX4k4rIc7oKmjumT4HfG","i5"))
