...
document.getElementById("i1").addEventListener('change',clickupload("fileurl1","1EDycZHiQfL3hg0qRfN-kueQELgHru9Qh","i1"))
...
const targetDate = new Date("July 17, 2024 18:00:00").getTime();
...
function clickto(){
 var val = "NIFTEM-T Placement Drive 24 - Siri Foods";
