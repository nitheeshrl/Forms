...
document.getElementById("i1").addEventListener('change',clickupload("fileurl1","13mM8Pe1SEUO2N2dDnR0GdLDE_ehA8P2X","i1"))
...
const targetDate = new Date("July 11, 2024 12:00:00").getTime();
...
function clickto(){
 var val = "NIFTEM-T Placement Drive 24 - Nandus Food Pvt Ltd";
