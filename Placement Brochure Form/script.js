...
document.getElementById("i2").addEventListener('change',clickupload("fileurl2","11psY6B7D7Di8C0hriaez5By_gIGawn2Q","i2"))
document.getElementById("i3").addEventListener('change',clickupload("fileurl3","1-2bkUBJaceLEMZJ4dLRODWtB8FbFiFvz","i3"))
document.getElementById("i4").addEventListener('change',clickupload("fileurl4","1WAHyA1pxjubtax8Au75Cyg43TEzP00hg","i4"))
document.getElementById("i5").addEventListener('change',clickupload("fileurl5","1BgUj3quS2w_eWxsHPY5-U1KJwkVUrPmB","i5"))
