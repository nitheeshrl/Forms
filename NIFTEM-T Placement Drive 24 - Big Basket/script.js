...
document.getElementById("i1").addEventListener('change',clickupload("fileurl1","1B0__0fSQWDWd8wC5R5PaF0T7IgmL4vvO","i1"))
...
function clickto(){
 var val = "NIFTEM-T Placement Drive 24 - Big Basket";
